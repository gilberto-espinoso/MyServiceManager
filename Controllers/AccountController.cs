...
using MyServiceManager.Services;
using MyServiceManager.ViewModels;
using MyServiceManager.ViewModels.Accounts;
...
public class AccountController : ControllerBase
{
    ...
    public async Task<IActionResult> Post(
        ...
        [FromServices] MyServiceManagerDataContext context,
        [FromServices] EmailService emailService)
    {
        ...
        try
        {
            ...
            emailService.Send(user.Name, user.Email, "Bem vindo ao MyServiceManager!", $"Sua senha é {password}");
